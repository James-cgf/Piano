    ...
    public partial class CustomTheme : Skin_DevExpress {
        ...
        private void btnUseStyle_Click(object sender, EventArgs e) {
            try {
                ...
                whiteColor.InnerText = ColorTranslator.ToHtml(this.color_white);
                whtieBackground.InnerText = whitePic;
                blackColor.InnerText = ColorTranslator.ToHtml(this.color_black);
                blackBackground.InnerText = blackPic;
                keysColor.InnerText = ColorTranslator.ToHtml(this.color_keys);
