...
namespace PinaoUI.As {
    public partial class CACodeAbout : Skin_DevExpress {
        ...
        private void AsForm_Load(object sender, EventArgs e) {
            this.EXEName.Text = "Piano T-" + Integration.getImpurity.nowEdition();
            this.webBrowser1.Url = new Uri("http://www.adminznh.ren/PianoNotice/aboutPiano.html");
        }
        /// <summary>
        /// 添加好友
        /// </summary>
        ...
        private void label1_Click(object sender, EventArgs e) {
            System.Diagnostics.Process.Start("http://www.adminznh.ren/");
        }
    }
}
